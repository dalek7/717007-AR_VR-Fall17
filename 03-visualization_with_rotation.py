...
fn = "pose/TangoPose/out_20000101_185919_855635_pose.txt" # pose 01 - 신예림
fn = "pose/TangoPose/out_20000101_185953_781812_pose.txt" # pose 02 - 김동훈
fn = "pose/TangoPose/out_20000101_190350_166419_pose.txt" # pose 09 - 김현주
dat = np.loadtxt (fn)
...
draw_axis(ax, x, y, z, rx, ry, rz, scale= 0.02) # axis 그리기
...
ax.set_aspect('auto')
plt.title(fn_wo_ext)
plt.savefig('examples/3d_traj_axis_{}.svg'.format(fn_wo_ext))
plt.savefig('examples/3d_traj_axis_{}.png'.format(fn_wo_ext))
